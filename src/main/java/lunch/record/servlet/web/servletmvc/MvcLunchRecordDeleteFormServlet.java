...
@WebServlet(name = "mvcLunchRecordDeleteFormServlet", urlPatterns = "/servlet-mvc/lunchRecord/delete-form/*")
public class MvcLunchRecordDeleteFormServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String viewPath = "/WEB-INF/views/form/delete-form.jsp";
